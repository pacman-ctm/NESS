...
class DatasetGen(object):
    ...
    def get(self, task_id):
        ...
        self.dataloaders[task_id]['name'] = f'iMiniImageNet-{task_id}-{self.task_ids[task_id]}'
        ...
        print (f"Training set size:   {len(train_loader.dataset)} images of {self.inputsize[1]}x{self.inputsize[1]}")
        print (f"Validation set size: {len(valid_loader.dataset)} images of {self.inputsize[1]}x{self.inputsize[1]}")
        print (f"Train+Val  set size: {len(valid_loader.dataset)+len(train_loader.dataset)} images of {self.inputsize[1]}x{self.inputsize[1]}")
        print (f"Test set size:       {len(test_loader.dataset)} images of {self.inputsize[1]}x{self.inputsize[1]}")
    ...
    def update_memory(self, task_id):
        ...
        print(len(self.task_memory[task_id]['x']))
        print (f"Memory updated by adding {len(self.task_memory[task_id]['x'])} images")